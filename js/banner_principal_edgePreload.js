...
if(document.addEventListener ){ 
   ...
   aLoader = [
      { load: "../js/edge_includes/jquery-2.0.3.min.js"},
      { load: "../js/edge_includes/edge.4.0.0.min.js"},
      { load: "../js/banner_principal_edge.js"},
      { load: "../js/banner_principal_edgeActions.js"}];
...
var plSTF="both",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="1200px",plHeight="600px";
